namespace Infrastructure
{
	public partial class PopupNotificationForm : Mbb.Windows.Forms.Form
	{
		...
		public void ShowAlert(string message, Caption caption, byte[] picture)
		{
			...
			{
				case Caption.موفقیت:
					notificationStatusPicturBox.Image = HOOKAH_SALON.Properties.Resources.succes_512;
					BackColor = System.Drawing.Color.SeaGreen;
					captionLabel.Text = Caption.موفقیت.ToString();
					break;

				case Caption.اخطار:
					notificationStatusPicturBox.Image = HOOKAH_SALON.Properties.Resources.warning_512;
					BackColor = System.Drawing.Color.DarkOrange;
					captionLabel.Text = Caption.اخطار.ToString();
					break;

				case Caption.خطا:
					notificationStatusPicturBox.Image = HOOKAH_SALON.Properties.Resources.error_512;
					BackColor = System.Drawing.Color.DarkRed;
					captionLabel.Text = Caption.خطا.ToString();
					break;

				case Caption.اطلاع:
					notificationStatusPicturBox.Image = HOOKAH_SALON.Properties.Resources.info_512;
